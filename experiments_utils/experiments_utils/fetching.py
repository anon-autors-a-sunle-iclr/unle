...
class Result:
    ...
    def slurm_err_file_contents(self):
        ...
        print(''.join(self._slurm_err_file_contents))
    ...
    def slurm_out_file_contents(self):
        ...
        print(''.join(self._slurm_out_file_contents))
...
class ResultsManager:
    def __init__(self, folder_name):
        import os
        self.abs_folder_name = Path(os.getcwd()) / "results" / folder_name
    ...
    def _should_reload(self) -> bool:
        import os.path
        last_mtime = os.path.getmtime(self.abs_folder_name / "results.pkl")
        return self._last_mtime is None or last_mtime > self._last_mtime
    ...
    def _get_index_df(self, minimal=False) -> pd.Series:
        with open(self.abs_folder_name / "results.pkl", "rb") as f:
            import hashlib
            this_hash_val = hashlib.md5(f.read()).hexdigest()
